...
export default function Test() {
    ...
    const test = (e) => {
        ...
        Axios.post("http://localhost:3000/test", {
            ...
            // navigate("/result", { state: { ...response.data, Name, Gender, Address, Contact, Pregnancies, Glucose, BloodPressure, SkinThickness, Insulin, BMI, DiabetesPedigreeFunction, Age } });
        }
        )
    }
    ...
    return <>
        ...
        <div className="containerTest">
            ...
            <form >
                ...
                <div id="btnTest">
                    <button className="btn1Test" onClick={test}> Test </button>
